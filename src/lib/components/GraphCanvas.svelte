...
<script lang="ts">
    ...
    import {width, height, canvas as canvasStore, context as contextStore} from '$lib/turing/graph';
    ...
    function handle_mouse_move({ clientX, clientY }: { clientX: number, clientY: number }) {
